...
import com.kayky.shipping_cost_api_domain.exception.NotFoundException;
...
public class OrderRepositoryImpl implements IOrderRepository {
    ...
    public Order findById(String id) {
        OrderOrm orderOrm = repository.findById(id).orElseThrow(() -> new NotFoundException("Order not found"));
        return OrderMapper.toEntity(orderOrm);
    }
